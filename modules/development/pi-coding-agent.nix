...
in
{
  ...
  # Per-user Pi configuration. The binary itself comes from the NixOS half
  # above; this owns the JSON files under ~/.pi/agent/ that we want
  # Nix-managed (settings, models, the pinned skill bundle).
  #
      ...
      home.file.".pi/agent/models.json".text = builtins.toJSON {
        providers.cortecs = {
          ...
          models = [
            ...
            # settings.json above. Listing them here is REQUIRED: the cortecs
